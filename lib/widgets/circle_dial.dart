...
class CircleDial extends StatelessWidget {
  ...
  CircleDial(
      {required this.radius, required this.value, required this.dialColorData});
          ...
          builder: (ctx, double value, _) {
            return Stack(
              ...
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(cos(2 * pi * value - pi / 2),
                      sin(2 * pi * value - pi / 2)),
                  child: Card(
                    elevation: 10,
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
        Rect.fromCircle(center: center, radius: radius), 0, angle!, false, arc);
  }
